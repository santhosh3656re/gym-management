...
-- Gymmer Access Logs
CREATE TABLE gymmer_access_log (
...
CREATE INDEX idx_gymmer_plan_status ON gymmer(plan_id, status);
CREATE INDEX idx_payment_gymmer_date ON payments(gymmer_id, payment_date);
CREATE INDEX idx_attendance_date_gymmer ON attendance(date, gymmer_id);
...
-- Insert Admin
INSERT INTO admin (username, password_hash, full_name, email, phone, role) VALUES
...
INSERT INTO membership_plan (plan_name, duration_months, price, description, features, max_trainer_sessions) VALUES
...
-- Insert Trainers
INSERT INTO trainer (full_name, email, phone, specialization, certification, experience_years, hourly_rate, joined_date, bio) VALUES
...
-- Insert Gymmers
INSERT INTO gymmer (username, password_hash, full_name, email, phone, date_of_birth, gender, address, emergency_contact, emergency_phone, plan_id, trainer_id, join_date, membership_start, membership_end, status) VALUES
...
INSERT INTO gymmer_profile (gymmer_id, height_cm, weight_kg, blood_group, fitness_goal, target_weight_kg) VALUES
...
-- Insert Payments
INSERT INTO payments (gymmer_id, plan_id, amount, payment_date, payment_method, transaction_id, billing_month) VALUES
...
INSERT INTO attendance (gymmer_id, check_in_time, check_out_time, date) VALUES
...
-- Insert Equipment
INSERT INTO equipment (equipment_name, category, quantity, purchase_date, price, condition_status, location) VALUES
...
INSERT INTO workout_plan (gymmer_id, trainer_id, plan_name, day_of_week, exercises, duration_minutes, difficulty, start_date) VALUES
...
-- Insert Diet Plans
INSERT INTO diet_plan (gymmer_id, trainer_id, plan_name, meal_type, meal_items, total_calories, total_protein_g, total_carbs_g, total_fat_g, start_date) VALUES
...
INSERT INTO progress_tracking (gymmer_id, record_date, weight_kg, body_fat_percentage, chest_cm, waist_cm, biceps_cm) VALUES
